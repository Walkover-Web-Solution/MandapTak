...
// in simulator we redefine to format for Demo Developer console
...
{\
	NSString * exceptionName = [@"org.demo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.demo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDemoNativeItemNone = -1, 
	UIDemoNativeItemSpinner = -2,
	UIDemoNativeItemProgressBar = -3,
	
	UIDemoNativeItemSlider = -4,
	UIDemoNativeItemSwitch = -5,
	UIDemoNativeItemMultiButton = -6,
	UIDemoNativeItemSegmented = -7,
	
	UIDemoNativeItemTextView = -8,
	UIDemoNativeItemTextField = -9,
	UIDemoNativeItemSearchBar = -10,
	
	UIDemoNativeItemPicker = -11,
	UIDemoNativeItemDatePicker = -12,
	
	UIDemoNativeItemInfoLight = -13,
	UIDemoNativeItemInfoDark = -14,
	
	UIDemoNativeItemDisclosure = -15,
	
	UIDemoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Demo instances of
